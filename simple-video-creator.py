...
def create_demo_video():
    ...
    cmd2 = [
        ...
        '-vf', f'drawtext=text="Project Overview":fontcolor=white:fontsize=54:x=(w-text_w)/2:y=80,drawtext=text="• Blockchain-based credential verification":fontcolor=white:fontsize=28:x=80:y=180,drawtext=text="• NFT minting for completed projects":fontcolor=white:fontsize=28:x=80:y=230,drawtext=text="• AI-driven credit scoring":fontcolor=white:fontsize=28:x=80:y=280,drawtext=text="• Micro-lending pool for gig workers":fontcolor=white:fontsize=28:x=80:y=330,drawtext=text="• Built with Solidity and JavaScript":fontcolor=white:fontsize=28:x=80:y=380',
        'slide2.mp4'
    ]
    ...
    cmd3 = [
        ...
        '-vf', f'drawtext=text="Smart Contract Features":fontcolor=white:fontsize=54:x=(w-text_w)/2:y=80,drawtext=text="ProfessionalCredentialNFT Contract":fontcolor=0xffd700:fontsize=32:x=80:y=180,drawtext=text="• Mint NFTs for completed projects":fontcolor=white:fontsize=26:x=100:y=240,drawtext=text="• Store project metadata on-chain":fontcolor=white:fontsize=26:x=100:y=280,drawtext=text="• Track work history and ratings":fontcolor=white:fontsize=26:x=100:y=320,drawtext=text="• Calculate creditworthiness scores":fontcolor=white:fontsize=26:x=100:y=360,drawtext=text="• Enable lending pool participation":fontcolor=white:fontsize=26:x=100:y=400',
        'slide3.mp4'
    ]
    ...
    cmd4 = [
        ...
        '-vf', f'drawtext=text="Web Frontend Demo":fontcolor=white:fontsize=54:x=(w-text_w)/2:y=80,drawtext=text="Modern Web Interface":fontcolor=white:fontsize=36:x=80:y=160,drawtext=text="✓ Connect MetaMask Wallet":fontcolor=white:fontsize=26:x=100:y=220,drawtext=text="✓ Mint Professional Credential NFTs":fontcolor=white:fontsize=26:x=100:y=260,drawtext=text="✓ View Work History and Ratings":fontcolor=white:fontsize=26:x=100:y=300,drawtext=text="✓ Check Credit Score":fontcolor=white:fontsize=26:x=100:y=340,drawtext=text="✓ Apply for Micro-loans":fontcolor=white:fontsize=26:x=100:y=380,drawtext=text="Built with HTML5, CSS3, JavaScript and Web3.js":fontcolor=0x1a1a2e:fontsize=22:x=(w-text_w)/2:y=450',
        'slide4.mp4'
    ]
